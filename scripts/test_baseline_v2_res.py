...
Test a set of baseline_v2_res Networks
...
def main():
    ...
    # -- records --
    approx_exps = cache_io.get_exps("exps/test_baseline_v2_res/first_grid.cfg")
    exact_exps = cache_io.get_exps("exps/test_baseline_v2_res/exact_grid.cfg")
